...
function DentroCiudad() {
    ...
    if (name == "" || isNaN(days) || days < 1 || isNaN(can)) {
        ...
        if (can >= 2) {
            ...
            let recibo = "Recibo de " + name + "   ID: " + idCliente + "\n" + 
                         "Servicio: Dentro de la Ciudad" + "\n" +
                         "Días alquilados: " + days + "\n" + 
                         "Computadores alquilados: " + can + "\n" + 
                         "Total: $ " + total;
...
function DiasAdicionales() {
    ...
    let diasExtra = prompt("¿Desea agregar días adicionales? \n(Ingrese número de dias o 0 para cancelar)");
